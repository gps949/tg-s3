...
-- ALTER TABLE multipart_parts ADD COLUMN created_at TEXT;
-- ALTER TABLE objects ADD COLUMN system_metadata TEXT;
-- ALTER TABLE multipart_uploads ADD COLUMN system_metadata TEXT;
